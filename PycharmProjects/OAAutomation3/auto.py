...
class OAtest():
	...
	#    dr.switch_to_frame("Main")
	   ...
	   # element=dr.find_element_by_xpath('/html/body/div/div/div[2]/ul[3]/li[3]/p[1]/a')
		#开始读table表了
		my_file= 'C:\\Users\\Lenovo\\Desktop\\aa\\OAAutomation3\\Table\\Fire.csv'
...
#                print table1
	...
	def approveleaveprogress(self,biaoti,index,flag=1):
		dr = self.dr
		print u"传过来的参数是%s"%biaoti
		print u"现在flag的值是%s"%flag
		frame = dr.find_element_by_xpath("/html/frameset/frameset").find_element_by_tag_name("frame")
	...
	#         input.click()
	 #           break
	   ...
	   # assert(biaoti,xiaobiaoti.text)
		...
		time.sleep(3)
		if index==1:
			dr.find_element_by_xpath("/html/body/div/div/div[2]/div[2]/table/tbody/tr[10]/td[2]/div/textarea").send_keys("tongyi")
		elif index==2:
			dr.find_element_by_xpath("/html/body/div/div/div[2]/div[2]/table/tbody/tr[11]/td[2]/div/textarea").send_keys("tongyi")
		if flag==0:
